...
public class AppMain {
    ...
    public static void main(String[] args) {
        System.out.println("====================================================");
        System.out.println("           Bem-vindo ao Chef.g Console App          ");
        System.out.println("====================================================");
        menuPrincipal();
    }
    ...
    private static void menuLogado() {
        ...
        do {
            System.out.println("\n[MENU DE AUTOR]");
            System.out.println("Usuário: " + usuarioLogado.getNome() + " | Nível: " + usuarioLogado.getNivelConta());
    ...
    private static void coletarIngredientes(ReceitaModel receita) throws Exception { 
        ...
        do {
            ...
            System.out.print("Quantidade (" + ingredienteDB.getUnidade_medida().name() + "): ");
